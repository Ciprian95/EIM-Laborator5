...
public class StartedServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceIntent.setComponent(new ComponentName(Constants.SERVICE_APP, Constants.SERVICE));
    ...
    protected void onResume() {
        ...
        registerReceiver(this.startedServiceBroadcastReceiver, this.startedServiceIntentFilter);
    }

    @Override
    protected void onPause() {
        // TODO: exercise 8c - unregister the broadcast receiver
        unregisterReceiver(this.startedServiceBroadcastReceiver);
